...
class DialogCadDeletado: DialogFragment() {
    lateinit var binding: DialogUsuariodeletadoBinding
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return activity?.let{
            binding =
                DialogUsuariodeletadoBinding.inflate(requireActivity().layoutInflater).apply {
